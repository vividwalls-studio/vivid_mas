...
-- Create VividWalls knowledge base tables

-- Enable pgvector extension
CREATE EXTENSION IF NOT EXISTS vector;

-- Create main knowledge table
CREATE TABLE IF NOT EXISTS vividwalls_knowledge (
...
-- Create index on source_type for faster queries
CREATE INDEX IF NOT EXISTS idx_vividwalls_knowledge_source_type ON vividwalls_knowledge(source_type);
CREATE INDEX IF NOT EXISTS idx_vividwalls_knowledge_metadata ON vividwalls_knowledge USING GIN(metadata);

-- Create embeddings table
CREATE TABLE IF NOT EXISTS vividwalls_embeddings (
    id SERIAL PRIMARY KEY,
    knowledge_id INTEGER REFERENCES vividwalls_knowledge(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_vividwalls_embeddings_vector 
ON vividwalls_embeddings 
USING ivfflat (embedding vector_cosine_ops)
WITH (lists = 100);

-- Clear existing data (optional - uncomment if needed)
-- TRUNCATE vividwalls_knowledge CASCADE;


-- Insert knowledge data

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'What types of abstract art collections are available at Vivid Walls?', 'Q: What types of abstract art collections are available at Vivid Walls?
A: Vivid Walls offers a diverse range of abstract art collections, including Geometric Intersection, Geometric Symmetry, Chromatic Echoes, Shape Emergence, Fractal Color, Mosaics, Vivid Layers, and Intersecting Spaces.', 'Abstract art, Collections', '{"type": "qa", "index": 0}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Can I customize the size of an artwork?', 'Q: Can I customize the size of an artwork?
A: Yes, we offer customization options for artwork sizes to fit your specific space requirements. Please contact our support team for more details.', 'Customization, Sizing', '{"type": "qa", "index": 1}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'What materials are used in your artworks?', 'Q: What materials are used in your artworks?
A: Our artworks are created using high-quality canvases and premium inks to ensure vibrant colors and longevity.', 'Materials, Quality', '{"type": "qa", "index": 2}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Do you offer framing options?', 'Q: Do you offer framing options?
A: Yes, we provide various framing options, including different colors and styles, to complement your chosen artwork.', 'Framing, Customization', '{"type": "qa", "index": 3}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'What is the price range of your artworks?', 'Q: What is the price range of your artworks?
A: Our artworks start from $400 USD, with prices varying based on size and framing options.', 'Pricing, Products', '{"type": "qa", "index": 4}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'How can I place an order?', 'Q: How can I place an order?
A: You can place an order directly through our website by selecting your desired artwork and following the checkout process.', 'Ordering, Online purchase', '{"type": "qa", "index": 5}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'What payment methods do you accept?', 'Q: What payment methods do you accept?
A: We accept various payment methods, including American Express, Apple Pay, Diners Club, Discover, Meta Pay, Google Pay, Mastercard, PayPal, Shop Pay, Venmo, and Visa.', 'Payment, Transactions', '{"type": "qa", "index": 6}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Do you ship internationally?', 'Q: Do you ship internationally?
A: Yes, we offer international shipping to various countries. Shipping costs and delivery times may vary based on location.', 'Shipping, International', '{"type": "qa", "index": 7}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'How long does delivery take?', 'Q: How long does delivery take?
A: Delivery times vary depending on your location and the chosen shipping method. Typically, orders are processed within 5-7 business days.', 'Shipping, Delivery times', '{"type": "qa", "index": 8}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Is there a shipping policy I can review?', 'Q: Is there a shipping policy I can review?
A: Yes, you can review our detailed shipping policy on our website under the ''Shipping Policy'' section.', 'Shipping, Policies', '{"type": "qa", "index": 9}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Can I track my order?', 'Q: Can I track my order?
A: Yes, once your order is shipped, you will receive a tracking number via email to monitor your shipment.', 'Shipping, Order tracking', '{"type": "qa", "index": 10}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'What if my artwork arrives damaged?', 'Q: What if my artwork arrives damaged?
A: If your artwork arrives damaged, please contact our customer service within 7 days of delivery for assistance with a replacement or refund.', 'Customer service, Returns', '{"type": "qa", "index": 11}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Do you offer returns or exchanges?', 'Q: Do you offer returns or exchanges?
A: Yes, we have a return and exchange policy. Please refer to our ''Refund Policy'' on the website for detailed information.', 'Returns, Exchanges', '{"type": "qa", "index": 12}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Can I request a custom artwork?', 'Q: Can I request a custom artwork?
A: Yes, we accept custom artwork requests. Please reach out to our artist through the ''Contact'' page to discuss your vision.', 'Customization, Commission', '{"type": "qa", "index": 13}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Who is the artist behind Vivid Walls?', 'Q: Who is the artist behind Vivid Walls?
A: Our artworks are created by a talented artist dedicated to producing unique abstract pieces. More information is available on the ''Artist'' page.', 'Artist, About Us', '{"type": "qa", "index": 14}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'What is the inspiration behind the artworks?', 'Q: What is the inspiration behind the artworks?
A: Our pieces are inspired by geometric abstraction, color theory, and emotional expression, blending modern design with timeless artistic principles.', 'Inspiration, Abstract art', '{"type": "qa", "index": 15}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Do you offer bulk pricing for businesses?', 'Q: Do you offer bulk pricing for businesses?
A: Yes, we offer special pricing for bulk purchases. Please contact us for wholesale inquiries.', 'Wholesale, Business', '{"type": "qa", "index": 16}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'What types of businesses benefit from Vivid Walls art?', 'Q: What types of businesses benefit from Vivid Walls art?
A: Our artworks are ideal for offices, restaurants, hotels, and residential spaces looking to enhance their ambiance with high-quality abstract pieces.', 'Office decor, Hospitality, Home decoration', '{"type": "qa", "index": 17}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'How do I choose the right artwork for my space?', 'Q: How do I choose the right artwork for my space?
A: Consider your space’s color palette, lighting, and intended atmosphere. We also offer consultation services to help you select the perfect piece.', 'Interior design, Art selection', '{"type": "qa", "index": 18}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Can I get a digital preview before purchasing?', 'Q: Can I get a digital preview before purchasing?
A: Yes, we offer digital previews to help visualize how an artwork will look in your space. Contact us for details.', 'Preview, Customization', '{"type": "qa", "index": 19}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Are your artworks limited editions?', 'Q: Are your artworks limited editions?
A: Yes, many of our pieces are available as limited edition prints, ensuring exclusivity for our customers.', 'Limited edition, Products', '{"type": "qa", "index": 20}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'What mediums are used in your artworks?', 'Q: What mediums are used in your artworks?
A: Our artist primarily works with acrylics and digital media, producing vibrant and lasting pieces.', 'Mediums, Materials', '{"type": "qa", "index": 21}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'How should I care for my artwork?', 'Q: How should I care for my artwork?
A: To maintain your artwork''s quality, avoid direct sunlight, dust it regularly with a soft cloth, and keep it away from moisture.', 'Artwork care, Maintenance', '{"type": "qa", "index": 22}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Do you collaborate with interior designers?', 'Q: Do you collaborate with interior designers?
A: Yes, we welcome collaborations with interior designers to provide art solutions tailored to specific projects.', 'Collaboration, Interior design', '{"type": "qa", "index": 23}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Can I see the artwork in person before purchasing?', 'Q: Can I see the artwork in person before purchasing?
A: Currently, we operate exclusively online, but we provide high-resolution images and detailed descriptions to assist your decision.', 'Online gallery, Viewing', '{"type": "qa", "index": 24}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'What sizes are available for your artworks?', 'Q: What sizes are available for your artworks?
A: Our artworks come in various sizes, and we also offer custom sizing to fit your specific needs.', 'Sizing, Customization', '{"type": "qa", "index": 25}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Do you offer gift cards?', 'Q: Do you offer gift cards?
A: Yes, we offer gift cards in various denominations, perfect for gifting art to others.', 'Gift cards, Products', '{"type": "qa", "index": 26}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Is there a newsletter I can subscribe to?', 'Q: Is there a newsletter I can subscribe to?
A: Yes, you can subscribe to our newsletter on our website to receive updates on new collections and exclusive offers.', 'Newsletter, Updates', '{"type": "qa", "index": 27}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'How can I contact customer support?', 'Q: How can I contact customer support?
A: You can reach our customer support through the ''Contact'' page on our website or by emailing support@vividwalls.co.', 'Customer support, Contact', '{"type": "qa", "index": 28}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Do you offer installation services?', 'Q: Do you offer installation services?
A: While we don''t provide installation services, we include hanging hardware and instructions with each artwork.', 'Installation, Support', '{"type": "qa", "index": 29}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Are there any ongoing promotions?', 'Q: Are there any ongoing promotions?
A: We periodically offer promotions and discounts. Subscribe to our newsletter or follow us on social media for updates.', 'Promotions, Discounts', '{"type": "qa", "index": 30}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('qa', 'vividwalls-q&a - vividwalls-q&a.csv', 'Can I purchase a digital copy of an artwork?', 'Q: Can I purchase a digital copy of an artwork?
A: Currently, we only offer physical prints and ', '', '{"type": "qa", "index": 31}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('product', 'Vividwalls Product Catalog Final.csv', 'Intersecting Perspectives No3', 'Product: Intersecting Perspectives No3
Type: Artwork
Category: Posters, Prints, & Visual Artwork
Description: Intersecting Perspectives No3from the Geometric Intersect collection showcases a sophisticated geometric abstract composition featuring intersecting lines and perspective shifts that create a complex visual narrative. This artwork demonstrates how linear elements can intersect to generate new spatial relationships and dimensional illusions that challenge conventional perspective. The carefully orchestrated intersections create points of convergence and divergence that guide the viewer''s eye through a maze of geometric relationships, each offering a different viewpoint on the same fundamental structure. The interplay between foreground and background elements generates depth and movement, while the strategic use of color helps differentiate between various perspective planes.
Tags: Intersecting Perspectives
Available in 6 variants', 'Intersecting Perspectives', '{"type": "product", "variant_count": 6, "has_images": true}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('product', 'Vividwalls Product Catalog Final.csv', 'Intersecting Perspectives No2', 'Product: Intersecting Perspectives No2
Type: Artwork
Category: Posters, Prints, & Visual Artwork
Description: Intersecting Perspectives No2from the Geometric Intersect collection presents a bold geometric composition featuring dynamic intersecting forms that create compelling visual dialogues between different dimensional perspectives. This artwork explores the fascinating interplay that occurs when geometric shapes meet, overlap, and influence each other''s visual presence. The intersecting elements generate new forms and negative spaces that weren''t present in the individual components, demonstrating how geometric interaction can create emergent complexity. The composition employs strategic color placement and angular relationships to guide the viewer''s eye through multiple visual pathways, each offering a different perspective on the same geometric relationships.
Tags: Intersecting Perspectives
Available in 6 variants', 'Intersecting Perspectives', '{"type": "product", "variant_count": 6, "has_images": true}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('product', 'Vividwalls Product Catalog Final.csv', 'Intersecting Perspectives No1', 'Product: Intersecting Perspectives No1
Type: Artwork
Category: Posters, Prints, & Visual Artwork
Description: Intersecting Perspectives No.1 from the Resonating Structure collection is a compelling display of the artist''s ability to invoke depth through minimalistic design. This piece strikes a commanding presence, its bold monochromatic shapes creating a stark interplay of contrast and negative space. Here, the artist employs a palette of black, white, and greys to sculpt the illusion of volume and space. The composition is both geometrically rigorous and intriguingly imprecise, suggesting a fluidity of movement within its rigid bounds. The texture applied throughout the piece gives it a tactile quality, as if the shapes are carved out of the canvas itself. Intersecting Perspectives No.1 is a masterful exercise in restraint and intentionality, where the artist uses the absence of color to emphasize form and shadow, inviting the viewer to fill the voids with personal interpretation. The artwork is a meditation on the essence of form and the space it occupies, both physically and metaphorically.
Tags: Intersecting Perspectives
Available in 6 variants', 'Intersecting Perspectives', '{"type": "product", "variant_count": 6, "has_images": true}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('product', 'Vividwalls Product Catalog Final.csv', 'Deep Echoes', 'Product: Deep Echoes
Type: Artwork
Category: Posters, Prints, & Visual Artwork
Description: Deep Echoes from the Chromatic Echoes collection showcases a vibrant geometric composition that evokes the shimmering facets of a gemstone. The piece is characterized by layers of overlapping shapes in varying shades of deep blues, creating a visual depth that suggests a multifaceted surface. The central alignment and mirroring of shapes give the artwork a balanced and harmonious aesthetic, reminiscent of the symmetry found in natural crystals.
Tags: Chromatic Echoes
Available in 6 variants', 'Chromatic Echoes', '{"type": "product", "variant_count": 6, "has_images": true}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('product', 'Vividwalls Product Catalog Final.csv', 'Space & Form no4', 'Product: Space & Form no4
Type: Artwork
Category: Posters, Prints, & Visual Artwork
Description: Space &amp; Form no4 from the Resonating Structure collection presents an abstract geometric artwork that explores the fundamental concepts of space and form through sophisticated digital composition. This piece investigates how geometric elements can define, occupy, and transform space while simultaneously being shaped by their spatial context. The artwork demonstrates the dynamic relationship between positive and negative space, showing how form can emerge from emptiness and how emptiness can define form. Through careful manipulation of scale, positioning, and color relationships, the composition creates a sense of dimensional depth that transcends the flat digital medium. Each geometric element serves both as an individual form and as a contributor to the larger spatial narrative, creating a complex dialogue between parts and whole that invites contemplation of how we perceive and understand three-dimensional relationships in a two-dimensional space.
Tags: Space Form
Available in 6 variants', 'Space Form', '{"type": "product", "variant_count": 6, "has_images": true}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('product', 'Vividwalls Product Catalog Final.csv', 'Vista Echoes', 'Product: Vista Echoes
Type: Artwork
Category: Posters, Prints, & Visual Artwork
Description: Vista Echoes from the Chromatic Echoes collection presents an evocative play of shapes and colors that echo the depth and vastness of a panoramic view. Deep blues and purples form the foundation of the piece, suggesting the mysteries of the twilight sky or the depths of the ocean. Intersecting geometric forms in contrasting hues of pink and lighter blue create an illusion of light refracting through a prism, offering a sense of dimensionality and complexity.
Tags: Chromatic Echoes
Available in 6 variants', 'Chromatic Echoes', '{"type": "product", "variant_count": 6, "has_images": true}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('product', 'Vividwalls Product Catalog Final.csv', 'Noir Echoes', 'Product: Noir Echoes
Type: Artwork
Category: Posters, Prints, & Visual Artwork
Description: Noir Echoesfrom the Chromatic Echoes collection by the artist is a visually striking digital tapestry that weaves together depth, contrast, and geometric symmetry. This piece delves into the monochromatic spectrum, masterfully playing with shades from the darkest black to the brightest white to create a symphonic visual experience. The art gives a nod to the op art movement, with its potential to evoke movement through static imagery. Staring at the artwork, one might feel the pulsating patterns and shifting planes, as the gradients of gray add a gentle rhythm to the starkness of the black and white. ''Chromatic Echoes Noir'' is a modern exploration of the enduring power of grayscale, utilizing digital means to create a timeless aesthetic. It stands as a bold statement on the power of simplicity and the intricate beauty that can be found within a restricted color palette.
Tags: Chromatic Echoes
Available in 6 variants', 'Chromatic Echoes', '{"type": "product", "variant_count": 6, "has_images": true}'::jsonb);

INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('product', 'Vividwalls Product Catalog Final.csv', 'Emerald Echoes', 'Product: Emerald Echoes
Type: Artwork
Category: Posters, Prints, & Visual Artwork
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Dark Kimono', 'Inventory for: Dark Kimono
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Earth Echoes', 'Inventory for: Earth Echoes
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Earthy Kimono', 'Inventory for: Earthy Kimono
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Earthy Shade', 'Inventory for: Earthy Shade
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Earthy Weave', 'Inventory for: Earthy Weave
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Emerald Shade', 'Inventory for: Emerald Shade
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Festive Patterns No1', 'Inventory for: Festive Patterns No1
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Festive Patterns No2', 'Inventory for: Festive Patterns No2
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Festive Patterns No3', 'Inventory for: Festive Patterns No3
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Fractal Color Dark', 'Inventory for: Fractal Color Dark
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Fractal Color Dark Double', 'Inventory for: Fractal Color Dark Double
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Fractal Color Light', 'Inventory for: Fractal Color Light
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Fractal Color Red', 'Inventory for: Fractal Color Red
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Fractal Double Red', 'Inventory for: Fractal Double Red
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Fractal Noir', 'Inventory for: Fractal Noir
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Fractal Noir Double', 'Inventory for: Fractal Noir Double
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Intersecting Perspectives No2', 'Inventory for: Intersecting Perspectives No2
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Intersecting Perspectives No3', 'Inventory for: Intersecting Perspectives No3
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Monochrome Kimono', 'Inventory for: Monochrome Kimono
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Noir Mosaic No1', 'Inventory for: Noir Mosaic No1
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Noir Mosaic No2', 'Inventory for: Noir Mosaic No2
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Noir Mosaic No3', 'Inventory for: Noir Mosaic No3
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Noir Shade', 'Inventory for: Noir Shade
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Noir Structures', 'Inventory for: Noir Structures
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Noir Weave', 'Inventory for: Noir Weave
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Olive Weave', 'Inventory for: Olive Weave
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Parallelogram Illusion No1', 'Inventory for: Parallelogram Illusion No1
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Parallelogram Illusion No2', 'Inventory for: Parallelogram Illusion No2
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Pink Weave', 'Inventory for: Pink Weave
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Primary Hue', 'Inventory for: Primary Hue
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Prismatic Warmth', 'Inventory for: Prismatic Warmth
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Purple Shade', 'Inventory for: Purple Shade
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Red Kimono', 'Inventory for: Red Kimono
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Royal Kimono', 'Inventory for: Royal Kimono
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Royal Shade', 'Inventory for: Royal Shade
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Rusty Shade', 'Inventory for: Rusty Shade
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Space Form No1', 'Inventory for: Space Form No1
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Space Form No2', 'Inventory for: Space Form No2
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Space Form No3', 'Inventory for: Space Form No3
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Structured Noir No1', 'Inventory for: Structured Noir No1
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Structured Noir No2', 'Inventory for: Structured Noir No2
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Teal Earth', 'Inventory for: Teal Earth
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Teal Kimono', 'Inventory for: Teal Kimono
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Textured Noir No1', 'Inventory for: Textured Noir No1
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Textured Royal No1', 'Inventory for: Textured Royal No1
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Untiled N011', 'Inventory for: Untiled N011
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Verdant Layers', 'Inventory for: Verdant Layers
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Vista Echoes', 'Inventory for: Vista Echoes
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Vivid Mosaic No1', 'Inventory for: Vivid Mosaic No1
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Vivid Mosaic No2', 'Inventory for: Vivid Mosaic No2
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Vivid Mosaic No3', 'Inventory for: Vivid Mosaic No3
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Vivid Mosaic No5', 'Inventory for: Vivid Mosaic No5
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Vivid Mosaic No6', 'Inventory for: Vivid Mosaic No6
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
INSERT INTO vividwalls_knowledge (source_type, source_file, title, content, tags, metadata)
VALUES ('inventory', 'inventory_export_canvas_limited_edition_300_TOTAL.csv', 'Vivid Mosaic No7', 'Inventory for: Vivid Mosaic No7
Total available: 600 units
Total on hand: 600 units
Locations: 170 Avenue F, Printful
Variants: 12', '', '{"type": "inventory", "variant_count": 12, "location_count": 2}'::jsonb);
...
CREATE OR REPLACE FUNCTION search_vividwalls_knowledge(
...
CREATE OR REPLACE VIEW vividwalls_knowledge_summary AS
SELECT 
    source_type,
